...
enum VisibleRace {V_MURLOC, V_DEMON, V_MECHANICAL, V_ELEMENTAL, V_BEAST, V_TOTEM, V_PIRATE, V_DRAGON, V_NAGA,
                  ...
                  V_TOTEM_ALL, V_PIRATE_ALL, V_DRAGON_ALL, V_NAGA_ALL, V_NUM_RACES};
...
public:
    ...
    static std::vector<Point2f> findTemplateOnScreen(QString templateImage, QScreen *screen, std::vector<Point2f> templatePoints, QPointF &screenScale, int &screenHeight);
