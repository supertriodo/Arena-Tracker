...
bool EnemyHandHandler::isClonerCard(const QString &code)
{
    QStringList candidates = { MIMIC_POD, THISTLE_TEA, TOLINS_GOBLET, ELEMENTARY_REACTION, GRAND_EMPRESS_SHEKZARA,
        ENCUMBERED_PACK_MULE, DOOR_OF_SHADOWS, SERVICE_BELL, CREATION_PROTOCOL_FORGED, SKETCH_ARTIST, BOTTOMLESS_TOY_CHEST, ROACH
    };
...
bool EnemyHandHandler::isDrawSpecificCards()
{
    QStringList candidates = { GNOMISH_EXPERIMENTER,FAR_SIGHT,VARIAN_WRYNN,TAELAN_FORDRING,MALYGOS_THE_SPELLWEAVER,
        ...
        STARGAZING, MESADUNE_THE_FRACTURED, MESSENGER_BUZZARD, TEN_GALLON_HAT, TAKE_TO_THE_SKIES, PENDANT_OF_EARTH,
        FETCH, WATERCOLOR_ARTIST, SCALE_REPLICA, CHALK_ARTIST, CARICATURE_ARTIST, HAGATHA_THE_FABLED, FAIRY_TALE_FOREST,
        DIG_FOR_TREASURE, PLUCKY_PAINTFIN, GAME_MASTER_NEMSY, QUALITY_ASSURANCE, UMPIRES_GRASP, COLIFERO_THE_ARTIST,
        CHIA_DRAKE, TRINKET_ARTIST, SKETCH_ARTIST, BARGAIN_BIN,
        BIRDWATCHING, UNDER_THE_SEA, BUTTONS, TORTOLLAN_TRAVELER, ALL_YOU_CAN_EAT, GRILLMASTER,
        UNGORO_BROCHURE, DALARAN_BROCHURE, BURNDOWN,
        DIRDRA_REBEL_CAPTAIN, LIBRAM_OF_CLARITY, BLAZING_ACCRETION, ETHEREAL_ORACLE, COSMONAUT, TROUBLED_MECHANIC,
        INTERSTELLAR_RESEARCHER, NYDUS_WORM, LIFT_OFF, CHRONO_BOOST, BLINK,
        EXOTIC_HOUNDMASTER, EMERALD_BOUNTY, DRAGONSCALE_ARMAMENTS, URSINE_MAUL, DREAMWARDEN, ROTHEART_DRYAD, FAE_TRICKSTER,
        TORMENTED_DREADWING, REFORESTATION, NIGHTMARE_LORD_XAVIUS, LIVING_FLAME, SEARING_REFLECTION,
        TORGA, FLIGHT_OF_THE_FIREHAWK, VOLCANIC_THRASHER, CONJURED_BOOKKEEPER, STORY_OF_BARNABUS, HYBRIDIZATION, DREAD_RAPTOR,
        CURSED_CATACOMBS, PLATYSAUR, HOLY_EGGBEARER,
        PORTAL_VANGUARD, TINY_RAFAAM, AXE_OF_CENARIUS, CHRONOGOR, DISCIPLE_OF_THE_DOVE, CHROMIE, TALANJI_OF_THE_GRAVES,
        PRECURSORY_STRIKE, THE_KINGSLAYERS
    };
