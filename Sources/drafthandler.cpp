...
bool DraftHandler::isSignatureCard(const QString &code)
{
    QStringList candidates = {
        ...
        KAZAKUS, PATCHES_THE_PIRATE, DON_HANCHO, AYA_BLACKPAW, TIRION_FORDRING, CENARIUS, LOATHEB, RENO_JACKSON, SIR_FINLEY_MRRGGLTON,
        BRANN_BRONZEBEARD, ELISE_STARSEEKER, YSHAARJ_RAGE_UNBOUND, NZOTH_THE_CORRUPTOR, YOGG_SARON_HOPES_END, CTHUN, CTHUN2, AYA_BLACKPAW2, DON_HANCHO2
    };
