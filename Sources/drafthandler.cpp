...
bool DraftHandler::isSignatureCard(const QString &code)
{
    QStringList candidates = {
        ...
        //EX1/FP1 3
        TIRION_FORDRING, CENARIUS, LOATHEB,
        //LOE 4
        ...
        //TOY 14
        HEMET_FOAM_MARKSMAN, TOYRANNOSAURUS, WATERCOLOR_ARTIST, RAZA_THE_RESEALED, HAGATHA_THE_FABLED, SONYA_WATERDANCER, GAME_MASTER_NEMSY,
        LINA_SHOP_MANAGER, LAB_PATRON, SKY_MOTHER_AVIANA, PIPSI_PAINTHOOF, RAMBUNCTIOUS_STUFFY, CORRIDOR_SLEEPER, CICIGI,
        //TTN 15
