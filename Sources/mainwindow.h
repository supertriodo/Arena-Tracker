...
#define HSR_CARDS_INCLUDED_14DAYS "https://hsreplay.net/api/v1/analytics/query/card_included_popularity_report/?GameType=ARENA&TimeRange=LAST_14_DAYS"
#define HSR_CARDS_PLAYED_14DAYS "https://hsreplay.net/api/v1/analytics/query/card_played_popularity_report/?GameType=ARENA&TimeRange=LAST_14_DAYS"
#define HSR_CARDS_INCLUDED "https://hsreplay.net/api/v1/analytics/query/card_included_popularity_report/?GameType=ARENA&TimeRange=CURRENT_PATCH"
#define HSR_CARDS_PLAYED "https://hsreplay.net/api/v1/analytics/query/card_played_popularity_report/?GameType=ARENA&TimeRange=CURRENT_PATCH"
